    ...
    <div class="d-flex">
        <div class="sidebar d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="Surgery_SpecialitiesList.php" class="nav-link active text-white">
        ...
        <!-- PHP IMPORTS -->
            <?php include './Surgery_AddSpecialityModal.php'; ?>
            <?php include './Surgery_EditSpecialityModal.php'; ?>
