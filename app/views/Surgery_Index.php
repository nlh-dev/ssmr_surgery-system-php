    ...
    <div class="d-flex">
        <div class="sidebar d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="">
                    <a href="Surgery_Index.php" class="nav-link active" aria-current="page">
                        <i class="sidebar-icons fa-solid fa-house"></i>Inicio
                    </a>
                </li>
                <li>
                    <a href="Surgery_DoctorList.php" class="nav-link text-white">
        ...
        <!-- PHP MODAL ACTIONS -->
        <?php include './Surgery_AddPatientsModal.php'; ?>
        <?php 
            $Doctors->data_seek(0);
            $PatientState->data_seek(0); 
            $Surgery->data_seek(0);
        ?>
        <?php include './Surgery_EditPatientsModal.php'; ?>
        <?php include './Surgery_DeletePatientsModal.php'; ?>
    </div>
